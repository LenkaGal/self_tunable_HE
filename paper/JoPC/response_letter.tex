...
\begin{document}
	...
	\answer{
		In order to improve the quality of the paper, we added the Figure~\ref{fig:HE_scheme} to the section Results and discussion:
		
		TODO: Nezabudnut pridat symboly to nomenklatury!
