...
\begin{subequations}
	...
	\begin{eqnarray}
		\label{eq:tunable_R}
		&~& R(t) = (1-\rho(t)) \, R_\mathrm{L} + \rho(t) \, R_\mathrm{U}, \\
		\label{eq:tunable_Qx}
		&~& Q_\mathrm{x}(t) = (1-\rho(t)) \, Q_\mathrm{x,L} + \rho(t) \, Q_\mathrm{x,U}, \\
		\label{eq:tunable_Qy}
		&~& Q_\mathrm{y}(t) = (1-\rho(t)) \, Q_\mathrm{y,L} + \rho(t) \, Q_\mathrm{y,U},
	\end{eqnarray}
\end{subequations}
...
%\begin{subequations}
	\begin{eqnarray}
		\label{eq:tunable_u}
		u(t) = (1-\rho(t)) \, u_\mathrm{L} + \rho(t) \, u_\mathrm{U},
	\end{eqnarray}
%\end{subequations}
