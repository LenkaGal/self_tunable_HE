...
\begin{subequations}
	...
	\label{eq:tunable_matrices}
		&~& R = (1-\rho)R_\mathrm{L} + \rho R_\mathrm{H}, \\
		&~& Q_\mathrm{x} = (1-\rho)Q_\mathrm{x,L} + \rho Q_\mathrm{x,H}, \\
		&~& Q_\mathrm{y} = (1-\rho)Q_\mathrm{y,L} + \rho Q_\mathrm{y,H},
	\end{eqnarray}
\end{subequations}
...
\begin{subequations}
	\begin{eqnarray}
		\label{eq:tunable_u}
		u = (1-\rho)u_\mathrm{L} + \rho u_\mathrm{H},
	\end{eqnarray}
\end{subequations}
