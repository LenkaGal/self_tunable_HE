...
\begin{document}
	...
	\textcolor{red}{From the point of computational complexity, the proposed tuning procedure does not lead to any significantly demanding mathematical operations. Simple relations in Eq.~\eqref{eq:rho_delta_ref} and Eq.~\eqref{eq:rho_tilde_def} are evaluated.}
