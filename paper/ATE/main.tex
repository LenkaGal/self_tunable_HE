...
\begin{document}
	...
	\begin{definition}[Scaling of the tuning parameter]
		\label{def:rho_tilde}
		Given the value of tuning parameter $\rho$, $0 \leq \rho \leq 1$, the splitting value of the tuning parameter interval $\rho_{\mathrm{s}}$, $0 < \rho_{\mathrm{s}} < 1$, and the value of the decision function $\gamma$, \textcolor{red}{$0 < \gamma < 1$}. Then the scaling of the tuning parameter $\widetilde{\rho}$ is given by:		
		\begin{eqnarray}
